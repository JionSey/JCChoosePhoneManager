...
@interface JCVPImageCropperViewController ()
...
@implementation JCVPImageCropperViewController
...
- (void)cancel:(id)sender {
    if (self.delegate && [self.delegate conformsToProtocol:@protocol(JCVPImageCropperDelegate)]) {
